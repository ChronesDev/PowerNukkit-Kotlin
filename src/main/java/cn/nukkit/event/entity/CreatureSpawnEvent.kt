...
class CreatureSpawnEvent : Event, Cancellable {
    ...
    private val compoundTag: CompoundTag

    constructor(networkId: Int, position: Position, nbt: CompoundTag, reason: SpawnReason) {
        this.reason = reason
    ...
    constructor(networkId: Int, position: Position, reason: SpawnReason) {
        this.reason = reason
        entityNetworkId = networkId
        this.position = position
        compoundTag = Entity.getDefaultNBT(position)
    }
