...
@PowerNukkitOnly
@Since("1.4.0.0-PN")
class GrindstoneItemAction @PowerNukkitOnly @Since("1.4.0.0-PN") constructor(sourceItem: Item, targetItem: Item, @get:PowerNukkitOnly
@get:Since("1.4.0.0-PN") val type: Int, @get:PowerNukkitOnly
                                                                             @get:Since("1.4.0.0-PN") val experience: Int) : InventoryAction(sourceItem, targetItem) {
